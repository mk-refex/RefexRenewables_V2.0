        ...
        {loading ? (
          ...
          <div className="flex flex-wrap justify-center gap-5 sm:gap-6">
            {managementMembers.map((member, index) => (
              <div
                key={member.id ?? index}
                className="w-full max-w-[300px] bg-brand text-white rounded-lg overflow-hidden group hover:shadow-xl transition-all duration-300 cursor-pointer sm:w-[calc(50%-0.75rem)] sm:max-w-none lg:w-[calc(33.333%-1rem)] xl:w-[calc(25%-1.125rem)]"
                onClick={() =>
