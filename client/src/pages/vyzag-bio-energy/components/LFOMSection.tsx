  ...
  return (
    <section className="bg-[#F9F9F9] py-16 lg:py-20">
      <div className="container mx-auto px-4 lg:px-[110px]">
        <div className="grid gap-10 md:grid-cols-2 md:items-start md:gap-14 lg:gap-16">
          <FadeInUp
            delay={0}
          ...
          >
            <div>
              <h2 className="text-2xl font-bold leading-tight text-gray-900 md:text-3xl lg:max-w-md lg:text-[28px] lg:leading-snug">
          ...
          <FadeInUp
            ...
            duration={0.5}
          >
            <p className="text-base leading-relaxed text-[#666666] md:text-lg">
