        ...
        <div className="max-w-7xl">
          <h1 className="text-white mb-8 leading-tight">
            <span className="inline-block animate-slideInLeft opacity-0" style={{ animationDelay: '0.1s', animationFillMode: 'forwards' }}>
              <span className="text-2xl font-bold sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl">Lighting the path to </span>
              <span className="text-4xl font-bold sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl">Sustainability</span>
            </span>
            <br />
            <span className="inline-block animate-slideInLeft opacity-0" style={{ animationDelay: '0.5s', animationFillMode: 'forwards' }}>
              <span className="text-2xl font-bold sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl">with </span>
              <span className="text-4xl font-bold sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl">Renewable </span>
              <span className="text-2xl font-bold sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl">Energy solutions</span>
            </span>
          </h1>

          <div className="mt-8 animate-slideInLeft opacity-0 sm:mt-12" style={{ animationDelay: '1s', animationFillMode: 'forwards' }}>
            <a
              href="/about-us"
