...
const PresenceSection = () => {
  ...
  const states = [
    {
      name: "Chhattisgarh",
      image: "/wp-content/uploads/2025/09/Chhattisgarh-map-new.png",
      position: { top: "50%", left: "48%" },
    },
    {
      name: "Gujarat",
      image: "/wp-content/uploads/2025/09/Gujarat-map.png",
      position: { top: "45%", left: "15%" },
    },
    {
      name: "Punjab",
      image: "/wp-content/uploads/2025/09/punjab-map.png",
      position: { top: "21%", left: "28%" },
    },
    {
      name: "Uttar Pradesh",
      image: "/wp-content/uploads/2025/09/Uttar-Pradesh-map.png",
      position: { top: "34%", left: "44%" },
    },
    {
      name: "Maharashtra",
      image: "/wp-content/uploads/2025/09/Maharashtra-map.png",
      position: { top: "57%", left: "26%" },
    },
    {
      name: "Delhi",
      image: "/wp-content/uploads/2025/09/delhi-map.png",
      position: { top: "27%", left: "33%" },
    },
    {
      name: "Madhya Pradesh",
      image: "/wp-content/uploads/2025/09/Madhya-Pradesh-map.png",
      position: { top: "45%", left: "36%" },
    },
    {
      name: "Rajasthan",
      image: "/wp-content/uploads/2025/09/Rajasthan-map.png",
      position: { top: "35%", left: "22%" },
    },
    {
      name: "Jammu and Kashmir",
      image: "/wp-content/uploads/2025/09/Ladakh-map.png",
      position: { top: "10%", left: "35%" },
    },
    {
      name: "Haryana",
      image: "/wp-content/uploads/2025/09/haryana-map.png",
      position: { top: "26%", left: "30%" },
    },
    {
      name: "Karnataka",
      image: "/wp-content/uploads/2025/09/Karnataka-map.png",
  ...
  return (
    <section className="relative overflow-hidden py-12 sm:py-16 lg:py-20">
      ...
      <div className="absolute inset-0">
        <img
          src="/wp-content/uploads/2025/09/bg-map.png"
          alt="Background"
