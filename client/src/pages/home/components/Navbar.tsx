          ...
          <div className="container mx-auto px-4 lg:px-8">
            <div className="flex items-center justify-between py-3">
              ...
              <nav className="hidden lg:flex items-center gap-6 xl:gap-8 ml-8">
                <Link
                  to="/"
                  className="text-sm font-bold text-gray-800 hover:text-brand transition-colors whitespace-nowrap"
                >
                  HOME
                </Link>
              ...
              <nav className="flex flex-col gap-2">
                ...
                <div>
                  ...
                  >
                    ABOUT US
                    <i
                      className={`ri-arrow-${openDropdown === "about" ? "up" : "down"}-s-line text-base`}
                    ></i>
                  </button>
                  {openDropdown === "about" && (
                ...
                <div>
                  ...
                  >
                    BUSINESSES
                    <i
                      className={`ri-arrow-${openDropdown === "business" ? "up" : "down"}-s-line text-base`}
                    ></i>
                  </button>
