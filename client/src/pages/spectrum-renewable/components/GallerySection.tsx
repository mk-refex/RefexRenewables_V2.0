    ...
    <section className="py-20 bg-white">
      <div className="container mx-auto px-4 lg:px-[110px]">
        <FadeInUp delay={0} className="mb-12">
          <SectionHeading
            badgeText="PILOT DIGESTER"
            text="R&D & Organic Farming"
            showWatermark={false}
          />
        ...
        <FadeInUp delay={0.2}>
          <div className="space-y-4 text-gray-700 mb-8 leading-relaxed">
            <p>
              SREPL operates a pilot digester at its plant to evaluate the
              ...
              planned to be replicated across upcoming units. In parallel, SREPL
              is engaging with farmers to promote the cultivation of Napier
              grass as a reliable, high-yield feedstock to support full-capacity
              plant operations.
            </p>
          </div>
        </FadeInUp>
